/*********************************
  ...
  Magic Mirror Module:
  MMM-DarkSkyForecast2
  https://github.com/jclarke0000/MMM-DarkSkyForecast2
...
Module.register("MMM-DarkSkyForecast2", {
    ...
    */
    ...
    defaults: {
        ...
        moduleTimestampIdPrefix: "DARK_SKY_TIMESTAMP_2_"
    },
    ...
    getStyles: function() {
        return ["MMM-DarkSkyForecast2.css"];
    },

    getTemplate: function() {
        return "mmm-darksky-forecast2.njk";
    },
    ...
    getData: function() {
        this.sendSocketNotification("DARK_SKY_FORECAST_2_GET", {
    ...
    socketNotificationReceived: function(notification, payload) {
        ...
        if (notification == "DARK_SKY_FORECAST_2_DATA" && payload.instanceId == this.identifier) {
            ...
            this.sendNotification("DARK_SKY_FORECAST_2_WEATHER_UPDATE", payload);
